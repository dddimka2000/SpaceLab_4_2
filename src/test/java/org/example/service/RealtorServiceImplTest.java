...
//        realtorDto.setId(1); // Simulate an existing realtor
//
//        when(realtorMapper.toEntity(realtorDto, minioService)).thenReturn(new Realtor());
...
//
//        // Verify interactions
//        verify(realtorMapper).updateEntityFromDto(realtorDto, any(), minioService);
//        verify(realtorService).save(any());
//    }
//
//    @Test
//    void testGetAll() {
...
//    }
    ...
    void testAddNewRealtor() throws Exception {
        ...
        when(realtorRepository.save(any())).thenReturn(null); // or any other appropriate return value
        // Act
        assertDoesNotThrow(() -> realtorService.add(realtorDto));
