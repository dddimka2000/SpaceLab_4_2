...
public class PageController {
    ...
    @PostMapping("/edit/{id}")
    @ResponseBody
    public ResponseEntity<?> editPage(@PathVariable Integer id, @Valid @ModelAttribute PageEntityDto pageEntityDto, BindingResult bindingResult) throws IllegalAccessException {
