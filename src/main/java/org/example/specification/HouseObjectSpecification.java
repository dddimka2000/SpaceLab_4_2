...
public class HouseObjectSpecification implements Specification<PropertyHouseObject> {
    ...
    public HouseObjectSpecification(ObjectForFilterDto objectForFilterDto) {
        ...
        maxFloor = objectForFilterDto.getMaxFloor();
        minPrice = objectForFilterDto.getMinPrice();
        maxPrice = objectForFilterDto.getMaxPrice();
        topozone = objectForFilterDto.getTopozone();
        plotAreaMin = objectForFilterDto.getPlotAreaMin();
        plotAreaMax = objectForFilterDto.getPlotAreaMax();
        minArea = objectForFilterDto.getMinArea();
