...
@Data
public class SecondaryObjectSpecification implements Specification<PropertySecondaryObject> {
    ...
    public SecondaryObjectSpecification(List<String> district, Integer numberRooms, Integer minFloor, Integer maxFloor, Integer minPrice, Integer maxPrice, List<String> topozone, List<Integer> residentialComplexId, Integer minNumberFloors, Integer maxNumberFloors, Integer minArea, Integer maxArea, String street, LocalDate lastContactDate) {
    ...
    @Override
    public Predicate toPredicate(Root<PropertySecondaryObject> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
    ...
    public static Specification<PropertySecondaryObject> nameContains(String name) {
